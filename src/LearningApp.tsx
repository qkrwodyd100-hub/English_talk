...
export default function LearningApp() {
  ...
  function speak() {
    ...
    window.speechSynthesis.speak(new SpeechSynthesisUtterance(current.english))
    setSpeechNotice('정답 문장을 재생했습니다.')
  }
