...
export default function LearningApp() {
  ...
  function handleAnswerKeyDown(event: KeyboardEvent<HTMLInputElement>) {
    ...
    if (event.key !== 'ArrowRight' || !checkedAnswer || navigationPosition >= navigationSentences.length - 1 || event.nativeEvent.isComposing || isComposingAnswer.current || event.ctrlKey || event.altKey || event.metaKey) return
    event.preventDefault()
    nextPractice()
  }
