...
export default defineConfig({
  testDir: './e2e',
  testMatch: ['learning.spec.ts', 'sequence-learning.spec.ts', 'shared-day-selector.spec.ts', 'cloud-sync.spec.ts', 'group-cloud-sync.spec.ts', 'voice-dictation.spec.ts', 'listening.spec.ts'],
